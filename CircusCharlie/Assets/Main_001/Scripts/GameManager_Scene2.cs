...
public class GameManager_Scene2 : MonoBehaviour
{
    //게임데이터에 접근합니다.
    public GameData gameData;

    // 싱글턴 인스턴스를 저장할 정적 변수
    public static GameManager_Scene2 instance;
    ...
    {
        // 점수를 실시간 갱신합니다.
        gameScore = gameData.score_Stage2;
        ...
        if (waitTime > 1.5f)
        {
            if (life > 0)
            {
                ...
                SceneManager.LoadScene("Stage2_Waiting");
            }
        }
    }
